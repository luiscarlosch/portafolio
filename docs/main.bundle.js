...
var InformacionService = (function () {
    ...
    InformacionService.prototype.carga_sobre_nosotros = function () {
        var _this = this;
        this.http.get("https://sitioweb-1b830.firebaseio.com/equipo.json")
            .subscribe(function (data) {
            // console.log(data.json());
...
var ProductosService = (function () {
    ...
    ProductosService.prototype.cargar_producto = function (cod) {
        return this.http.get("https://sitioweb-1b830.firebaseio.com/productos/" + cod + ".json");
    };
    ProductosService.prototype.cargar_productos = function () {
        var _this = this;
        this.cargando = true;
        var promesa = new Promise(function (resolve, reject) {
            _this.http.get('https://sitioweb-1b830.firebaseio.com/productos_idx.json')
                .subscribe(function (res) {
